...
/// HaptikCommerce.sharedSDK.loadConversation(launchController: self, attributes: attributes)
/// HaptikCommerce.sharedSDK.delegate = self
///
/// \endcode<h2>Objective-C Code</h2>
/// \code
/// // Import HaptikCommerce SDK
...
///
/// \endcode
SWIFT_CLASS("_TtC14HaptikCommerce14HaptikCommerce")
@interface HaptikCommerce : NSObject
/// Returns the HaptikCommerce singleton object
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) HaptikCommerce * _Nonnull sharedSDK;)
+ (HaptikCommerce * _Nonnull)sharedSDK SWIFT_WARN_UNUSED_RESULT;
...
@interface HaptikCommerce (SWIFT_EXTENSION(HaptikCommerce))
...
/// ]
///     // Send Event to SDK
/// HaptikCommerce.sharedSDK.updateEventData(withEventName: "mySdkEvent", eventData: eventData)
///
/// \endcode<h2>Objective-C Code</h2>
/// \code
/// // Form event data in `NSDictionary`
...
///                             };
/// // Send Event to SDK
/// [HaptikCommerce.sharedSDK updateEventDataWithEventName:@"mySdkEvent" eventData:eventData];
///
