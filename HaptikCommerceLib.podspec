...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Ketan Doiphode"
  # spec.authors            = { "Ketan Doiphode" => "ketan@haptik.ai" }
  ...
  # ――― Source Location ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  #
  #  Specify tvoshe location from where the source should be retrieved.
  ...
  #  spec.source_files  = "HaptikCommerceLib", "HaptikCommerceLib/**/*.{h,m,swift}"
  #  spec.exclude_files = "HaptikCommerceLib/Exclude"

  #  spec.public_header_files = "HaptikCommerceLib/**/*.h"
